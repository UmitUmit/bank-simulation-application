...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Transaction makeTransfer(BigDecimal amount, Date creationDate, Account sender, Account receiver, String message) {
        if (!underConstruction) {
            ...
            executeBalanceAndUpdateIfRequried(amount, sender, receiver);
    ...
    private void executeBalanceAndUpdateIfRequried(BigDecimal amount, Account sender, Account receiver) {
    ...
    private void validateAccounts(Account sender, Account receiver) {
        ...
        if (sender.getId().equals(receiver.getId())){
            throw new BadRequestException("Sender account needs to be different from the receiver account");
        }

        finndAccountById(sender.getId());
        finndAccountById(receiver.getId());
    }

    private Account finndAccountById(UUID accountId) {
